...
const CourseCard = ({ data }) => {
  ...
  return (
    <div
      ...
      className="relative w-[15rem] h-[320px] sm:h-[350px] rounded-lg cursor-pointer group overflow-hidden bg-transparent border border-gray-300 shadow-sm hover:shadow-lg transition-all duration-300 ease-out transform hover:scale-105"
    >
